...
myapp.controller('SheduleCtrl',function($scope,$resource, Mytitles, $http, Shedules, $ionicPopup){
  ...
  $scope.shedulesList = JSON.parse(window.localStorage['nCurrentShedule'] || '[{"0":{"day":"Понедельник"},"1":[{"lect":"Тихонов Сергей Викторович","time":"9:45-11:05","kind":"Лекция","aud":"419","task":"Геометрия"},{"time":"9:45-11:05","kind":"Практика","task":"Геометрия","lect":"Суворов Владимир Васильевич","aud":"606"}]},{"0":{"day":"Вторник"},"1":[]},{"0":{"day":"Среда"},"1":[{"time":"12:49-15:34","kind":"Лекция","task":"Геометрия","aud":"419","lect":"Суворов Владимир Васильевич"}]},{"0":{"day":"Четверг"},"1":[]},{"0":{"day":"Пятница"},"1":[]},{"0":{"day":"Суббота"},"1":[]}]' );
